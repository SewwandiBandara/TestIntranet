...
const HW = () => {
  ...
  const testConnection = async () => {
    try {
      console.log('Testing H&W API connection...');
  ...
  const fetchDocuments = async () => {
    try {
      console.log('Fetching H&W documents...');
      ...
      const mappedDocuments = data.files.map((file, index) => ({
        ...
        Category: 'H&W', // Default category
        Description: `H&W Document: ${file.filename}`, // Default description
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            View your H&W documents and procedures
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <h2 className="text-xl font-semibold flex items-center">
              ...
              H&W documents ({filteredDocuments.length})
            </h2>
