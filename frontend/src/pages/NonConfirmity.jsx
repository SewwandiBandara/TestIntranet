      ...
      <div className="relative z-10 flex-grow">
        ...
        <div className="pt-20 px-5 pb-8">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-6">Non Confirmity</h1>
            {/* <p className="text-xl text-gray-200">Company guidelines and operational procedures</p> */}
          </div>
          
          {/* Add feedback form content here */}
          <div className="flex justify-center">
                {/* Login Block - Updated styling */}
                <div className="bg-white bg-opacity-90 rounded-lg shadow-lg p-8 -m-6 backdrop-blur-sm ">
                  <h2 className="text-2xl font-bold text-blue-900 mb-4 ">Login to SRI NC System</h2>
                  ...
                  <form>
                    ...
                    <div className="mb-6">
                     ...
                     <div className='pt-3 flex items-center space-x-2'>
                        ...
                        value="option"
                        />
                        <label>Remember my login to this computer.</label>
                     </div>
                      {/* <p className="text-right mt-2 text-sm text-blue-600 hover:underline cursor-pointer">Remember my login to this computer.</p> */}
                    </div>
